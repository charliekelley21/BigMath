...
public class LList {
    ...
    public int remove() throws NoSuchElementException {
        if (curr == tail)   // nothing to remove
            throw new NoSuchElementException("remove() in LList has current of " + curr + " and size of " + listSize + " that is not a valid element");
    ...
    public int getValue() throws NoSuchElementException {
        if (curr == tail)
            throw new NoSuchElementException("getValue() in LList has current of " + curr + " and size of " + listSize + " that is not a valid element");
        return curr.element();
    }
    
    // addition for two LinkedLists
    public LList add() {
        return new LList();
    }
}
